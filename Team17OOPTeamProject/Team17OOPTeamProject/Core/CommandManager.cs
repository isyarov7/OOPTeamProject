...
namespace T17.Models.Core
{
    public class CommandManager : ICommandManager
    {
        public ICommand ParseCommand(string commandLine)
        {
            ...
            "changebugprioritytohigh" => new ChangeBugPriorityToHighCommand(commandParameters),
            "changebugprioritytolow" => new ChangeBugPriorityToLowCommand(commandParameters),
            "changestoryprioritytolow" => new ChangeStoryPriorityToLowCommand(commandParameters),
            "changestoryprioritytomedium" => new ChangeStoryPriorityToMediumCommand(commandParameters),
            "changestoryprioritytohigh" => new ChangeStoryPriorityToHighCommand(commandParameters),
